...
#Préparation des arguments pour l'utilisation avec le command line
parser = argparse.ArgumentParser(description="Record yourself in french to get the transcritpion",
                                 formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument("-t", "--time", default=10,  help="duration of recording in seconds")
...
fs = 16000  # Fréquence d'echantillonage (en Hz) # Durée de l'enregistrement
...
sleep(1)
print('go!')
enregistrement = sd.rec(int(time * fs), samplerate=fs, channels=1)
